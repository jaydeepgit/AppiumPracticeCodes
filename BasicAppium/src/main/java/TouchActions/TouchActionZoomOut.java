...
public class TouchActionZoomOut {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		int sX1 = (int) (width*0.8);
		int sY1 = (int) (height*0.2);
		int eX1 = (int) (width*0.5);
		int eY1 = (int) (height*0.5);
		
		
		int sX2 = (int) (width*0.2);
		int sY2 = (int) (height*0.8);
		int eX2 = (int) (width*0.5);
		int eY2 = (int) (height*0.5);
